      ...
      <Layout>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <Box>
            ...
            >
              A selection of stages, sadya layouts, reception setups and
              intimate details from the weddings and celebrations we&apos;ve
              styled. Every event is customised – this gallery is just a
              starting point for what we can create for you.
            </Typography>
                ...
                >
                  <Box sx={{ position: "relative", overflow: "hidden" }}>
                    <CardMedia
                      ...
                      sx={{
                        height:
                          index % 3 === 0 ? 260 : index % 3 === 1 ? 220 : 240,
                        width: "100%",
                        objectFit: "cover",
              ...
              <Grid size={{ xs: 12 }}>
                ...
                >
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    No images in this category yet. Please check another filter
                    or ask us for a customised mood board for your venue.
                  </Typography>
                </Box>
              </Grid>
            )}
            ...
            >
              <Box>
                ...
                >
                  ...
                  your enquiry, and we&apos;ll create a customised décor plan
                  based on your venue and budget.
                </Typography>
              </Box>
            </Stack>
          </Box>
