      ...
      <Layout>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <Box>
            ...
            >
              Kalysta Wedding Hub is a new venture built by a team that has
              spent over 15 years working behind the scenes of weddings and
              events. The people behind Kalysta come from strong backgrounds in
              décor, planning and professional cooking, and now bring that
              experience together under one name to create celebrations that
              feel warm, personal and luxuriously put together.
            </Typography>
          </Box>
              ...
              <Box sx={{ display: "flex", flexDirection: "column", gap: 3 }}>
                <Box>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    ...
                    receptions, birthdays and intimate gatherings with a focus
                    on aesthetic décor, seamless coordination and memorable food
                    experiences.
                  </Typography>
                </Box>
                ...
                <Box>
                  ...
                  >
                    ...
                    <strong>15+ years of hands-on experience</strong> gained
                    from working with various event organisers, caterers and
                    venues before starting this venture.
                  </Typography>
                  <ul style={ulStyle}>
                    <li>Wedding décor and stage design for varied venues</li>
                    <li>End-to-end event planning and guest flow management</li>
                    <li>
                      Professional cooking and menu planning for sadya, buffet
                      and reception cuisine
                    </li>
                  ...
                  >
                    This experience shows up in the small things – how the flow
                    of events is planned, how food timing is managed, and how
                    décor is adapted to your hall or home instead of forcing a
                    template. Now Kalysta Wedding Hub proudly serves Chengannur,
                    Thiruvalla, Pathanamthitta and nearby regions across Kerala
                    for weddings, receptions and family celebrations.
                  </Typography>
                </Box>ll
              </Box>
            </Grid>
                ...
                <CardContent>
                  ...
                  <Stack spacing={2.5} sx={{ mt: 2 }}>
                    <Box>
                      ...
                      >
                        of combined experience that the team brings into this
                        new venture from décor, event planning and professional
                        cooking backgrounds.
                      </Typography>
                    </Box>
                    ...
                    <Box>
                      ...
                      >
                        ...
                        engagement functions, birthdays and house events over
                        the years.
                      </Typography>
                    </Box>
          ...
          <Grid container spacing={4}>
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              >
                ...
                <strong>hygiene, quality and consistency</strong>:
              </Typography>
              <ul style={ulStyle}>
            ...
            <Grid size={{ xs: 12, md: 6 }}>
              ...
              <ul style={ulStyle}>
                ...
                <li>
                  We suggest ideas that match your venue, guest count and
                  budget.
                </li>
                <li>
              ...
              <Typography
                ...
                sx={{ color: "text.secondary", mt: 1 }}
              >
                The goal is simple: you enjoy your celebration like a guest,
                while we quietly take care of the rest.
              </Typography>
            </Grid>
          </Grid>
              ...
              <Card sx={valueCardStyle}>
                <CardContent>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    ...
                    pay attention to the details that guests may not see but
            ...
            <Grid size={{ xs: 12, md: 4 }}>
              <Card sx={valueCardStyle}>
                <CardContent>
                  ...
                  <Typography variant="body2" sx={{ color: "text.secondary" }}>
                    Weddings can be emotional and high-pressure. Our role is to
                    be the calm in the background, handling logistics so you can
          ...
          >
            ...
            >
              <Box>
                ...
                >
                  Tell us your date, venue and what kind of celebration
                  you&apos;re dreaming of. We&apos;ll share honest suggestions
                  and a package that fits your needs.
                </Typography>
              </Box>
              <Box>
                <Typography
