        ...
        <Box sx={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <Box>
            ...
            >
              ...
              details are customised based on guest count, location, décor
              style, menu preferences and technical requirements.
            </Typography>
                ...
                <CardContent>
                  ...
                  <Box sx={{ mt: 2 }}>
                    ...
                    <ul style={ulStyle}>
                      ...
                      <li>
                        <strong>Luxury Experience</strong> – high-impact
                        florals, custom structures, layered lighting and curated
                        thematic spots.
                      </li>
                    </ul>
                  </Box>
              ...
              <Card sx={cardStyle}>
                <CardContent>
                  ...
                  <ul style={ulStyle}>
                    ...
                    <li>
                      <strong>Custom Theme Stage</strong> – curated look
                      designed uniquely for your venue
                    </li>
                  </ul>
          ...
          <Grid container spacing={3}>
            <Grid size={{ xs: 12 }}>
              ...
              <Typography
                ...
                sx={{ color: "text.secondary", mb: 2 }}
              >
                Curated non-veg menus designed for receptions and evening
                events.
              </Typography>
            </Grid>
          ...
          >
            ...
            >
              ...
              Share your date, venue and expectations to receive a tailored
              plan.
            </Typography>
          </Box>
        </Box>
