      ...
      <Box sx={{ display: "flex", flexDirection: "column", gap: 6 }}>
        ...
        <Box>
          ...
          >
            ...
            story. From complete wedding planning to intimate family gatherings,
            we blend tradition, detail and luxury to create unforgettable
            experiences.
          </Typography>
            ...
            >
              <CardContent>
                ...
                >
                  ...
                  seamless, stress-free experience from the first discussion to
                  the final farewell.
                </Typography>
                <Typography
                  variant="body2"
                ...
                >
                  <ul style={{ margin: 0, paddingLeft: "1.1rem" }}>
                    <li>Concept & theme development tailored to your story</li>
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  sx={{ color: "text.secondary", mb: 1.5 }}
                >
                  We curate a blend of modern entertainment and traditional art
                  forms to reflect your personality and roots.
                </Typography>
                <Typography
                  variant="body2"
                  sx={{ color: "text.secondary" }}
            ...
            >
              <CardContent>
                ...
                <Typography
                  ...
                  sx={{ color: "text.secondary", mb: 1.5 }}
                >
                  A well-coordinated team on the ground ensures that every guest
                  feels welcomed and every moment runs smoothly.
                </Typography>
                <Typography
                  variant="body2"
                  sx={{ color: "text.secondary" }}
        ...
        >
          ...
          >
            <Box>
              ...
              >
                Share your date, venue and requirements, and we&apos;ll help you
