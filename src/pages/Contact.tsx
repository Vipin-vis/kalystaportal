  ...
  const handleWhatsApp = () => {
    if (!validate()) {
      setSnackbar({
        open: true,
        message:
          "Please fill in the required details before sending via WhatsApp.",
        severity: "error",
      });
      return;
    }
    ...
    const whatsappUrl = `https://wa.me/917907959859?text=${text}`;
      ...
      <Layout>
        <Box sx={{ display: "flex", flexDirection: "column", gap: 6 }}>
          ...
          <Box>
            ...
            >
              Share a few details about your event and our team will connect
              with you to discuss ideas, budgets and availability. We usually
              ...
              >
                <form onSubmit={handleSubmit} noValidate>
                  <Stack spacing={2.5}>
                    ...
                    >
                      &quot;Send via Gmail&quot; opens a new Gmail compose
                      window with your details pre-filled. &quot;Send via
                      WhatsApp&quot; opens a chat with Kalysta&apos;s number.
                    </Typography>
                  </Stack>
                </form>
              </Paper>
                ...
                <Stack spacing={1.5}>
                  <Stack direction="row" spacing={1.5} alignItems="center">
                    ...
                    <Box>
                      ...
                      <Typography variant="body2">+91 79079 59859</Typography>
                      <Typography
                        variant="caption"
                        sx={{ color: "text.secondary" }}
                      >
          ...
          >
            <Alert
              ...
              sx={{
                bgcolor:
                  snackbar.severity === "success" ? "primary.main" : undefined,
              }}
            >
              {snackbar.message}
            </Alert>
